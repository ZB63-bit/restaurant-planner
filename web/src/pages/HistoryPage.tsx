  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
      <div className="flex items-baseline justify-between gap-2">
        ...
        <span className="shrink-0 text-xs text-slate-400">{entry.visited_date}</span>
      </div>
      <Meta cuisine={entry.cuisine} rating={entry.google_rating} price={entry.price_level} />
      <div className="mt-2 flex items-center gap-2">
        <input
          className="flex-1 rounded-lg border border-slate-200 px-2 py-1 text-sm transition-colors duration-150 focus:border-brand focus:outline-none"
